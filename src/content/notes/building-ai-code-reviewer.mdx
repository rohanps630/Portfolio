...
excerpt: "How I built a production-grade AI agent that reviews GitHub pull requests with hybrid retrieval, tool use, and real evals — without LangChain or framework glue."
date: "2026-05-10"
category: "ai"
...
If you want to dig deeper, the [repo](https://github.com/rohanps630/ai-code-reviewer) has full architecture docs, ADRs for the major decisions, and a roadmap of where it's going.
