...
- **AI**: Anthropic Claude primary, OpenAI fallback, Voyage `voyage-code-3` embeddings, Cohere `rerank-v3.5`.
...
6. Cohere `rerank-v3.5` over the top 30.
